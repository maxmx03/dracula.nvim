...
theme.set_highlights = function(c)
  ...
  hl(0, "WinSeparator", { fg = c.comment, bg = c.float_bg })
  ...
  hl(0, "@text.html", { fg = c.fg, bg = 'NONE' })
  ...
  hl(0, "SagaWinbarEvent", { link = '@constant' })
  ...
  hl(0, "SagaWinbarArray", { fg = c.fg, bg = 'NONE' })
  ...
  hl(0, "NvimTreeWinSeparator", { fg = c.float_bg, bg = c.float_bg })
  ...
  hl(0, "NvimTreeEndOfBuffer", { fg = c.float_bg, bg = 'NONE' })
  ...
  hl(0, "CmpItemKindFolder", { fg = c.purple, bg = 'NONE' })
