...
M.set_highlight = function(colors, config)
  ...
  nvim_set_hl('WinSeparator', { fg = colors.base01, bg = colors.base04 }, { transparent = config.transparent })
  ...
  nvim_set_hl(
    'IncSearch',
    { fg = colors.red, bg = colors.shade_red, bold = true },
  ...
  nvim_set_hl('CursorLineNr', { fg = colors.purple, bg = colors.base03 }, { transparent = config.transparent })
  ...
  nvim_set_hl('Constant', { fg = colors.purple }, { styles = config.styles.constants })
  nvim_set_hl('String', { fg = colors.yellow }, { styles = config.styles.strings })
  ...
  nvim_set_hl('Function', { fg = colors.green }, { styles = config.styles.functions })
  nvim_set_hl('Statement', { fg = colors.pink }, { styles = config.styles.keywords })
  ...
  nvim_set_hl('Type', { fg = colors.cyan }, { styles = config.styles.types })
  ...
  if config.plugins['nvim-treesitter'] then
    ...
    nvim_set_hl('@variable.parameter', { fg = colors.orange, italic = true }, { styles = config.styles.parameters })
  ...
  if config.plugins['nvim-lspconfig'] then
    ...
    nvim_set_hl('@lsp.type.enumMember', { link = 'Constant' })
    ...
    nvim_set_hl('@lsp.type.parameter', { fg = colors.orange, italic = true }, { styles = config.styles.parameters })
  ...
  if config.plugins['neo-tree.nvim'] then
    nvim_set_hl('NeoTreeNormal', { fg = colors.base0, bg = colors.base04 }, { transparent = config.transparent })
  ...
  if config.plugins['nvim-tree.lua'] then
    ...
    nvim_set_hl('NvimTreeNormal', { fg = colors.base0, bg = colors.base04 }, { transparent = config.transparent })
